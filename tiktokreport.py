...
''')
    ...
    headers1 = {
        ...
        'same-origin',
        'tt-csrf-token':
        '3H0AVQGcx3wrGM9Ct5CM86g8',
        'user-agent':
        'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.150 Safari/537.36',
        'x-secsdk-csrf-token':
        '000100000001788eba932e33cf37b46dd7526624d86a87a58ecd646527ab2b87387e800e86d21662711de009d90a'
    }
    data1 = {
        'object_id': f"{ref2}",
        'owner_id': f"{ref2}",
    ...
    while True:
        time.sleep(3)
# Sending the first report request
...
if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"Thank you for your feedback"},"errMsg":"Thank you for your feedback"}' in req1:
    print('\033[1;92m[+] Report successful')
else:
    print('\033[0;92m[+] Report failed')
time.sleep(3)

# Sending the second report request
...
if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"Thank you for your feedback"},"errMsg":"Thank you for your feedback"}' in req2:
    ...
    print('\033[0;31m[+] Report failed')
time.sleep(3)

# Sending the third report request
...
if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"Thank you for your feedback"},"errMsg":"Thank you for your feedback"}' in req3:
    print('\033[0;92m[+] Report successful')
else:
    print('\033[0;92m[+] Report failed')
if kurd == '2':
    print('''
...
if kurd2 == '1':
    ...
    headers5 = {
        ...
        'https://www.tiktok.com',
        'referer':
        f'https://www.tiktok.com/@{username}?lang=ar&is_copy_url=1&is_from_webapp=v1',
        'sec-fetch-dest':
        'empty',
        'sec-fetch-mode':
        'cors',
...
if kurd2 == '2':
    ...
    headers6 = {
        ...
        'https://www.tiktok.com',
        'referer':
        f'https://www.tiktok.com/@{username2}?lang=ar&is_copy_url=1&is_from_webapp=v1',
        'sec-fetch-dest':
        'empty',
        'sec-fetch-mode':
        'cors',
...
if kurd2 == '3':
    ...
    headers30 = {
        ...
        'https://www.tiktok.com',
        'referer':
        f'https://www.tiktok.com/@{username3}?lang=ar&is_copy_url=1&is_from_webapp=v1',
        'sec-fetch-dest':
        'empty',
        'sec-fetch-mode':
        'cors',
